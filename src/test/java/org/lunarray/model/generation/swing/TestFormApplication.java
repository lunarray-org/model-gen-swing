...
import org.lunarray.model.generation.swing.components.impl.FormComponentBuilder;
...
/**
 * Test form with an application.
 * 
 * @author Pal Hargitai (pal@lunarray.org)
 * @see FormComponent
 */
@Ignore
public class TestFormApplication {
	/** Main. */
	public static void main(final String[] args) throws Exception {
		new TestFormApplication();
	}
	...
	/** Constructor. */
	public TestFormApplication() throws Exception {
		this.init();
	}
	...
	public void init() throws Exception {
		...
		final FormComponentBuilder<Object, Sample01> builder = FormComponentBuilder.createBuilder();
		builder.model(this.model).entityKey("Sample01").entity(this.instance).bottomMessages();
