 ...
 *            The entity type.
 */
public final class CheckboxOutputPropertyStrategy<P, E>
	 ...
	 */
	protected CheckboxOutputPropertyStrategy(final PropertyDescriptor<P, E> propertyDescriptor, final RenderContext<E> context) {
	...
	public GeneratedColumn<E, ?> getGenerator() {
		return new CheckboxColumnGenerator<P, E>(this);
	}
	...
	public static final class StrategyFactory
		...
		public <P, E> TablePropertyRenderStrategy<P, E> createStrategy(final RenderContext<E> context,
			...
			return new CheckboxOutputPropertyStrategy<P, E>(descriptor, context);
		}
	}
}
